/*
  ...
  - Added the required column `contactPerson` to the `Exhibitor` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Exhibitor" ("contact", "createdAt", "email", "id", "name", "phone", "updatedAt") SELECT "contact", "createdAt", "email", "id", "name", "phone", "updatedAt" FROM "Exhibitor";
