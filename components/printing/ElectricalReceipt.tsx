...
export function ElectricalReceipt({ open, onOpenChange, allocations }: ElectricalReceiptProps) {
    ...
    const handleWhatsAppShare = () => {
        ...
        if (receiptNumber) message += `Bill No: ${receiptNumber}\n`; // Adjusted line 39 context - wait, replace chunk logic needs care.

        // Let's do separate chunks or careful range
        // Chunk 1: WhatsApp Message
        // Chunk 2: Button
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-[95%] max-w-[600px] h-[90vh] max-h-[90vh] flex flex-col p-0 gap-0 overflow-hidden print:shadow-none print:border-none print:max-w-full print:w-full print:h-screen">
                ...
                <div className="overflow-y-auto flex-1 p-6">
                    <div className="print-content bg-white p-4 rounded-lg">
                        ...
                        <div className="text-center border-b pb-4 mb-4">
                            ...
                            <DialogTitle className="text-xl font-semibold uppercase tracking-wide text-center border-t pt-2 mt-2">Electrical Bill</DialogTitle>
                            {receiptNumber && <p className="text-lg font-semibold mt-1">Bill No: {receiptNumber}</p>}
                ...
                <div className="flex flex-wrap justify-end gap-2 mt-4 no-print">
                    ...
                    <Button variant="outline" onClick={handleWhatsAppShare} className="flex-1 sm:flex-none gap-2 border-green-600 text-green-600 hover:bg-green-50">
