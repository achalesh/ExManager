            ...
            <DialogContent className="sm:max-w-[600px] print:shadow-none print:border-none print:max-w-full print:w-full print:h-screen">
                ...
                <div className="print-content bg-white p-4 rounded-lg">
                    ...
                    <div className="text-center border-b pb-4 mb-4">
                        ...
                        <DialogTitle className="text-xl font-semibold uppercase tracking-wide text-center border-t pt-2 mt-2">Material Receipt</DialogTitle>
                    ...
                    <div className="mb-6">
                        <table className="w-full text-sm">
                                ...
                                {allocations.map((alloc) => (
                                    <tr key={alloc.id}>
                                        <td className="py-3">
                                            ...
                                            {alloc.isFOC && (
                                                <span className="text-xs bg-green-100 text-green-700 px-1.5 py-0.5 rounded">FOC</span>
                                            )}
                                            {alloc.items && alloc.items.length > 0 && (
                                                <div className="text-xs text-gray-500 mt-1 break-word w-full max-w-[200px]">
                            ...
                            <tfoot className="border-t-2 border-gray-100 font-semibold">
                                <tr>
                                    <td colSpan={3} className="pt-4 text-right pr-4">Grand Total</td>
